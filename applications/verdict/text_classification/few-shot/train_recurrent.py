...
class ModelArguments:
    model_name_or_path: str = field(default="chinese-xlnet-base", metadata={"help": "The build-in pretrained model or the path to local model."})
...
class PromptTrainer(PromptTrainer):
    ...
    def compute_forward(self, model, inputs):
        ...
        # loss, logits, mems, hidden_states, attentions
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0 or (
                    ...
                    self.state.global_step += inputs['num_chunks'][-1].item() + 1
